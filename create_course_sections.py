...
def create_course_sections():
    ...
    # Spring courses (semester_order = 2)
    cursor.execute("""
    ...
    # Teachers grouped by specialization
    ...
    # Classrooms grouped by room type
    ...
    # Specialization → room type mapping
    spec_room_map = {}
    ...
    # Core course slots (5-6 hours/week → 2-2.5 hour sessions)
    core_slots = [
        ('MWF', '08:00', '09:40'),
        ('MWF', '09:00', '10:40'),
        ('MWF', '10:00', '11:40'),
    ...
    # Elective slots (2-4 hours/week → 1-1.5 hour sessions)
    elective_slots = [
        ('MWF', '08:00', '09:00'),
        ('MWF', '09:00', '10:00'),
        ('MWF', '10:00', '11:00'),
    ...
    def get_section_count(code, grade_min, course_type):
        """400 students, 100 per grade, capacity 10 per section"""

        # Grade 9 core: ~100 students need this → 10 sections ideal, but limited by teachers
    ...
    # =========================================================================
    # STEP 6: Schedule sections with conflict checking
    # =========================================================================
    ...
    # Track schedules: teacher_id → [(day, start, end), ...]
    ...
    def can_assign_teacher(tid, day, start, end):
        """No time conflict + max 4 hours per day"""
